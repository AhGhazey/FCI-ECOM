            ...
            <div id="left_side_bar_staff" class="left_side_bar"> 
                ...
                <div id="left-menu-tree-content_Staff" class ="left_menu">
                    <div id ="staff_left_menu">
                        <ul>
                            <li ><a href="#" id="st_rslot" class="not-active">Reserve Slot</a></li>
                            <li ><a href="#" id="st_scd" class="not-active">My schedule</a></li>
                            <li><a href="#"  id="st_ofchr" class="not-active">Register Office Hours</a></li>
                            <li><a href="#"  id="stu_stfmail" class="not-active">Staff Mails</a></li>
                            <li><a href="#"  id="stu_gpteam" class="not-active">MY GP team</a></li>     
